...
/***/ "./js/module/statistic/canvasjs.min.js":
/*!*********************************************!*\
  !*** ./js/module/statistic/canvasjs.min.js ***!
  \*********************************************/
...
/* harmony export */   "CanvasJSModule": () => (/* binding */ CanvasJSModule)
/* harmony export */ });
...
(function () {
  ...
  function Ta(h, p, D) {
    if (h && p && D) {
      ...
      if ("undefined" !== typeof Blob && new Blob) {
        for (var F = h.replace(/^data:[a-z\/]*;base64,/, ""),
                 F = atob(F),
  ...
  function fb(h, p) {
    var D = this.length >>> 0, r = Number(p) || 0, r = 0 > r ? Math.ceil(r) : Math.floor(r);
    for (0 > r && (r += D); r < D; r++) if (r in this && this[r] === h) return r;
    return -1
  }
  ...
  function R(h, p) {
    ...
    }[h || "solid"]) for (var r = 0; r < D.length; r++) D[r] *= p; else D = [];
    return D
  }
  ...
  function ab(h, p, D) {
    ...
    p = !0;
    for (D = 0; 4 > D; D++) if (h[D] !== h[D + 4] | h[D] !== h[D + 8] | h[D] !== h[D + 12]) {
      p = !1;
      break
    }
  ...
  var $a = {}, xa                                              = null, kb                                   =
        ...
        return function (z, E, L) {
          ...
          L = S ? "getUTC" : "get";
          var U = z[L + "Date"](), V = z[L + "Day"](), M = z[L + "Month"](), Q = z[L + "FullYear"](), a = z[L + "Hours"](),
              d = z[L + "Minutes"](), b = z[L + "Seconds"](), c = z[L + "Milliseconds"](),
        ...
        var v                                                                         = r ? r.decimalSeparator : ".", H                                       = r ? r.digitGroupSeparator :
          ",", F = "";
        p = String(p);
        var F = 1, z = r = "", E = -1, L = [], R = [], I = 0, N = 0, S = 0, O = !1, U = 0,
            z = p.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        p = null;
        for (var Q = 0; z && Q < z.length; Q++) if (p = z[Q], "." === p && 0 > E) E = Q; else {
          if ("%" === p) F *= 100; else if ("\u2030" === p) {
            F *= 1E3;
            continue
        ...
        h = (p[1] + "").split("");
        F && "0" === F[0] && F.shift();
        for (O = z = Q = N = E = 0; 0 < L.length;) if (p = L.pop(), "#" === p || "0" === p) if (E++, E === I) {
          var M = F, F = [];
        ...
        z && (Q === S && 0 < F.length) && (r = H + r); else "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? "," === p ? (Q++, z = O, O = 0, 0 < F.length && (r = H + r)) : r = 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? p.slice(1, p.length - 1) + r : p + r : (p = 0 > U ? p.replace("+", "")
          .replace("-", "") : p.replace("-", ""), r += p.replace(/[0]+/, function (h) {
          return $(U, h.length)
        }));
        H = "";
        for (L = !1; 0 < R.length;) p = R.shift(), "#" === p || "0" === p ? 0 < h.length && 0 !== Number(h.join("")) ? (H += h.shift(), L = !0) : "0" === p && (H += "0", L =
          !0) : 1 < p.length && ('"' === p[0] && '"' === p[p.length - 1] || "'" === p[0] && "'" === p[p.length - 1]) ? H += p.slice(1, p.length - 1) : "E" !== p[0] && "e" !== p[0] || "0" !== p[p.length - 1] || !/[eE][+-]*[0]+/.test(p) ? H += p : (p = 0 > U ? p.replace("+", "")
          .replace("-", "") : p.replace("-", ""), H += p.replace(/[0]+/, function (h) {
          return $(U, h.length)
        }));
        r += (L ? v : "") + H;
        return u ? "-" + r : r
        ...
        return {x: p, y: r}
      }, bb = !0, Ua = window.devicePixelRatio || 1, Pa = 1, W = bb ? Ua / Pa : 1,
  ...
  V.prototype.set                     = function (h, p, r) {
    ...
    if ("options" === h) this.createUserOptions(p); else if (u.hasOwnProperty(h) || u.publicProperties && u.publicProperties.hasOwnProperty(h) && "readWrite" === u.publicProperties[h]) this.options._isPlaceholder && this.createUserOptions(), this.options[h] = p; else {
  ...
  V.prototype.createUserOptions       = function (h) {
    if ("undefined" !== typeof h || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
      ...
      var p                                          =
            this.parent.options[this.optionsName], r = p.length;
      this.options._isPlaceholder || (Fa(p), r = p.indexOf(this.options));
      this.options = "undefined" === typeof h ? {} : h;
      p[r]         = this.options
    } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? p = this.optionsName : (p = this._defaultsKey) && 0 !== p.length ? (r = p.charAt(0)
      .toLowerCase(), 1 < p.length && (r = r.concat(p.slice(1))), p = r) : p = void 0, h[p] = this.options
  };
  ...
  ka.prototype._getLineWithWidth = function (h, p, r) {
    ...
    for (this.ctx.font = this._getFontString(); u <= v;) {
      ...
      if (r < p) u = H + 1; else if (r > p) v = H - 1; else break
    }
  ...
  ka.prototype._wrapText         = function () {
    ...
    this.ctx.font = this._getFontString();
    if (0 === this.frontSize) v = u = 0; else for (; 0 < h.length;) {
      ...
      p.push(F);
      var z = v, v = Math.max(v, F.width), u = u + F.height, h = Ia(h.slice(F.text.length,
        h.length));
  ...
  Aa.prototype.setLayout = function () {
    if (this.text) {
      var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, p = h.layoutManager.getFreeSpace(), r = p.x1,
          v = p.y1, E = 0, H = 0,
          F = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, z, I;
  ...
  var Na = {
   ...
   true && "undefined" !== typeof module.exports ? module.exports = Na : "function" === typeof define && __webpack_require__.amdO ? define([],
    function () {
    return Na
  }) : canvasExportJS = Na;
  Na.Chart         = function () {
    ...
    function z(a, d, b, c, e, g) {
      ...
      this.stripLines = [];
      if (this.options.stripLines && 0 < this.options.stripLines.length) for (a = 0; a < this.options.stripLines.length; a++) this.stripLines.push(new X(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this));
    ...
    p.prototype._updateOptions              = function () {
      ...
      if (this.options.zoomEnabled) {
        ...
        this._resetButton || (d = !1, va(this._resetButton = document.createElement("button")), ua(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), O(this._resetButton, "touchstart", function (a) {
          ...
          if (a.sessionVariables.axisX2) for (c = 0; c < a.sessionVariables.axisX2.length; c++) a.sessionVariables.axisX2[c].newViewportMinimum = null, a.sessionVariables.axisX2[c].newViewportMaximum =
            null;
    ...
    p.prototype._initialize                 = function () {
      ...
      if (this.options.data) {
        for (var b =
          ...
          null === c.markerSize && (("line" === c.type || "stepLine" === c.type || "spline" === c.type || 0 <= c.type.toLowerCase()
            .indexOf("area")) && c.dataPoints && c.dataPoints.length < this.width / 16 || "scatter" === c.type) && (c.markerSize = 8);
    ...
    p.prototype.setLayout                   = function () {
      ...
      b = !1;
      if (0 < this._axes.length && (this.zoomEnabled || this.panEnabled)) for (d = 0; d < this._axes.length; d++) if (null !== this._axes[d].viewportMinimum || null !== this._axes[d].viewportMaximum) {
        b = !0;
        break
      }
      ...
      this.subtitles = [];
      if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) b = new Ka(this, this.options.subtitles[d], d), this.subtitles.push(b), b.dockInsidePlotArea ? a.push(b) : b.setLayout();
    ...
    p.prototype.renderElements              = function () {
      ...
      if ("normal" ===
        this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) z.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (var g = this.plotInfo.plotTypes[d], k = 0; k < g.plotUnits.length; k++) {
      ...
      if (0 < b.length) s.disableToolTip = !0, s._animator.animate(200, s.animationDuration, function (a) {
        ...
        b = [];
        for (var a = 0; a < s.plotInfo.plotTypes.length; a++) for (var e = s.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) e.plotUnits[d].targetCanvas = null;
        c                = null;
        s.disableToolTip = !1
      }); else {
        if (s._breaksCanvas) if (r) s.plotArea.ctx.drawImage(s._breaksCanvas, 0, 0, this.width, this.height); else for (m = 0; m < s._axes.length; m++) s._axes[m].createMask();
    ...
    p.prototype.categoriseDataSeries        = function () {
      for (var a = "", d = 0; d < this.data.length; d++) if (a =
        ...
        for (var b = null, c = !1, e = null, g = !1, k = 0; k < this.plotInfo.plotTypes.length; k++) if (this.plotInfo.plotTypes[k].type === a.type) {
          c = !0;
          b = this.plotInfo.plotTypes[k];
          break
        }
        c || (b = {type: a.type, totalDataSeries: 0, plotUnits: []}, this.plotInfo.plotTypes.push(b));
        for (k = 0; k < b.plotUnits.length; k++) if (b.plotUnits[k].axisYType === a.axisYType && b.plotUnits[k].axisXType === a.axisXType && b.plotUnits[k].axisYIndex === a.axisYIndex &&
    ...
    p.prototype._processData                = function () {
      ...
      for (var a = 0; a < this.plotInfo.plotTypes.length; a++) for (var d = this.plotInfo.plotTypes[a], b = 0; b < d.plotUnits.length; b++) {
        var c = d.plotUnits[b];
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
        ...
        for (w = 0; w < l.dataPoints.length; w++) {
          ...
          if (c < n && !m) null !== e && (q = c); else {
            ...
            if (c > f && !s) s = !0; else if (c > f && s) continue;
        ...
        for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = [], l = [], w = Infinity, m = -Infinity, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          for (n = 0; n < q.dataPoints.length; n++) {
            ...
            if (c < p && !f) null !== q.dataPoints[n].y && (h = c); else {
              ...
              if (c > t && !B) B = !0; else if (c > t && B) continue;
        ...
        for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, k = !1, l = !1, w = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          for (q = 0; q < s.dataPoints.length; q++) {
            ...
            if (c < h && !n) null !== e && (B = c); else {
              ...
              if (c > r && !f) f = !0; else if (c > r && f) continue;
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g, k, l = !1, w = 0; w < a.dataSeriesIndexes.length; w++) {
        ...
        for (s = 0; s < m.dataPoints.length; s++) {
          ...
          if (!(c < r) || q) {
            ...
            if (c > t && !n) n = !0; else if (c > t && n) continue;
            m.dataPoints[s].label && (a.axisX.labels[c] = m.dataPoints[s].label);
            c < b.viewPortMin && (b.viewPortMin = c);
            c > b.viewPortMax && (b.viewPortMax = c);
            if (b.viewPortMin === c && e) for (p = 0; p < e.length; p++) if (null === e[p] && f < c) {
              b.viewPortMin = f;
              break
            }
    ...
    p.prototype.calculateAutoBreaks         = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (c || b) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, m = f.min, l = f.max, k = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, w = 0, s = 0; s < a.dataSeriesIndexes.length; s++) {
            var h = e.data[a.dataSeriesIndexes[s]];
            if (!(4 > h.dataPoints.length)) for (w =
              ...
              if ((g = "waterfall" === a.type ? h.dataPointEOs[w].cumulativeSum : h.dataPoints[w].y) && g.length) for (var p = 0; p < g.length; p++) q = Math.floor((g[p] - k) / r), g[p] <
      ...
      function b(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var c = a.axisX.dataInfo, b = c.min, d = c.max, f = c._dataRanges, g, m = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (!(4 > k.dataPoints.length)) for (m = 0; m < k.dataPoints.length; m++) g =
      ...
      if (g) {
        ...
        for (k = 0; k < this._axes.length; k++) if (this._axes[k].dataInfo._dataRanges) {
          ...
          if (this._axes[k].dataInfo.dataPointYPositiveSums) {
            ...
            s     = m;
            for (l in n) if (n.hasOwnProperty(l) && !isNaN(l) && (q = n[l], !u(q))) {
          ...
          if (this._axes[k].scaleBreaks.customBreaks) for (l = 0; l < this._axes[k].scaleBreaks.customBreaks.length; l++) for (c = 0; c < g.length; c++) if (this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue || this._axes[k].scaleBreaks.customBreaks[l].startValue <= g[c].start && g[c].start <= this._axes[k].scaleBreaks.customBreaks[l].endValue ||
    ...
    p.prototype.getDataPointAtXY            = function (a, d, b) {
      b = b || !1;
      for (var c       =
                 [], e = this._dataInRenderedOrder.length - 1; 0 <= e; e--) {
        var g = null;
        (g = this._dataInRenderedOrder[e].getDataPointAtXY(a, d, b)) && c.push(g)
      }
      a = null;
      d = !1;
      for (b = 0; b < c.length; b++) if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type) if (e = na("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= e / 2) {
        d = !0;
        break
      }
    ...
    p.prototype.getObjectAtXY               = function (a, d, b) {
      var c = null;
      if (b = this.getDataPointAtXY(a, d, b || !1)) c = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (r) c = ab(a, d, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
    ...
    p.prototype._dispatchRangeEvent         = function (a, d) {
      ...
      for (var e = 0; e < c.length; e++) if (u(b[c[e]]) && (b[c[e]] = []), "axisY" === c[e]) for (var g = 0; g < this.axisY.length; g++) b[c[e]].push({
      ...
      }); else if ("axisY2" === c[e]) for (g =
                                             0; g < this.axisY2.length; g++) b[c[e]].push({
        viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum,
        viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum
      }); else if ("axisX" === c[e]) for (g = 0; g < this.axisX.length; g++) b[c[e]].push({
        viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum,
        viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum
      }); else if ("axisX2" === c[e]) for (g = 0; g < this.axisX2.length; g++) b[c[e]].push({
        viewportMinimum: this[c[e]][g].sessionVariables.newViewportMinimum,
        viewportMaximum: this[c[e]][g].sessionVariables.newViewportMaximum
      });
    ...
    p.prototype._mouseEventHandler          = function (a) {
      ...
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ja && window.console && (window.console.log(b + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
    ...
    p.prototype._plotAreaMouseUp            = function (a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        var b = d - this.dragStartPoint.y, c = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"),
            g = 0 <= this.zoomType.indexOf("y"), k = !1;
        this.resetOverlayedCanvas();
        if ("xySwapped" === this.plotInfo.axisPlacement) var l = g, g = e, e = l;
        if (this.panEnabled || this.zoomEnabled) {
          ...
          b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * g, b.sessionVariables.newViewportMaximum = b.viewportMaximum * g, k = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum / b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum / g, b.sessionVariables.newViewportMaximum = b.viewportMaximum / g, k = !0) : b.viewportMinimum < b.minimum ? (g = b.minimum - b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum + g, b.sessionVariables.newViewportMaximum = b.viewportMaximum +
            g, k = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum - b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum - g, b.sessionVariables.newViewportMaximum = b.viewportMaximum - g, k = !0); else if ((!e || 2 < Math.abs(c)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {
      ...
      if ("none" !== this.plotInfo.axisPlacement) {
        this.resetOverlayedCanvas();
        if (this.axisX && 0 < this.axisX.length) for (k = 0; k < this.axisX.length; k++) this.axisX[k].crosshair && this.axisX[k].crosshair.enabled &&
        this.axisX[k].renderCrosshair(a, d);
        if (this.axisX2 && 0 < this.axisX2.length) for (k = 0; k < this.axisX2.length; k++) this.axisX2[k].crosshair && this.axisX2[k].crosshair.enabled && this.axisX2[k].renderCrosshair(a, d);
        if (this.axisY && 0 < this.axisY.length) for (k = 0; k < this.axisY.length; k++) this.axisY[k].crosshair && this.axisY[k].crosshair.enabled && this.axisY[k].renderCrosshair(a, d);
        if (this.axisY2 && 0 < this.axisY2.length) for (k = 0; k < this.axisY2.length; k++) this.axisY2[k].crosshair && this.axisY2[k].crosshair.enabled && this.axisY2[k].renderCrosshair(a,
          d)
      }
    };
    p.prototype._plotAreaMouseMove          = function (a, d) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        var b = 0, c = 0, e = b = null, e = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"),
            k = this;
        ...
        if ((!e || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) &&
          (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = {
        ...
        if (this.axisX2 && 0 < this.axisX2.length) for (e = 0; e < this.axisX2.length; e++) this.axisX2[e].crosshair && this.axisX2[e].crosshair.enabled &&
    ...
    p.prototype.validateRegion              = function (a, d, b, c, e) {
      ...
      for (k = 0; k < m.length; k++) {
        ...
        if (n > f) var B = f, f = n, n = B;
        if (q.scaleBreaks) for (B = 0; !g && B < q.scaleBreaks._appliedBreaks.length; B++) g = q.scaleBreaks._appliedBreaks[B].startValue <= n && q.scaleBreaks._appliedBreaks[B].endValue >= f;
        if (isFinite(q.dataInfo.minDiff)) if (B = q.getApparentDifference(n, f, null, !0), !(g || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && B < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && B < 3 * Math.abs(q.dataInfo.minDiff)) || n < q.minimum || f > q.maximum)) w.push(q), s.push({
          val1: n,
          val2: f
        }), l =
          !0; else if (!e) {
    ...
    p.prototype.renderIndexLabels           = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a], s = m.chartType.toLowerCase(), q, n, l = na("indexLabelFontColor", m.dataPoint,
          m.dataSeries), w                                                   = na("indexLabelFontSize", m.dataPoint, m.dataSeries);
        ...
        var k                                                                = na("indexLabelFontWeight", m.dataPoint, m.dataSeries),
            ...
            h                                                                = na("indexLabelLineColor", m.dataPoint, m.dataSeries), p =
            ...
            t                                                                = {percent: null, total: null}, C = null;
        ...
        if (null !== x && "" !== x) {
          var t = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
              C = na("indexLabelOrientation", m.dataPoint, m.dataSeries), ma = m.direction, y = m.dataSeries.axisX,
              A = m.dataSeries.axisY, v = !1, f = new ka(d, {
                x: 0,
                y: 0,
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            if (0 <= s.indexOf("line") || 0 <= s.indexOf("area")) t = "auto", k = 4; else if (0 <= s.indexOf("stacked")) "auto" === t && (t = "inside"); else if ("bubble" === s || "scatter" === s) t = "inside";
            q = m.point.x -
              l / 2;
    ...
    p.prototype.renderSpline                = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var k = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          var p                           = 0, t, u, x              = [];
          c.beginPath();
          if (0 < s.length) for (u = !1, p = 0; p < s.length; p++) if (t = s[p].getTime ? s[p].x.getTime() : s[p].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !u))) if ("number" !== typeof s[p].y) 0 < p && !u && (m.connectNullData ? c.setLineDash && (0 < x.length && (m.options.nullDataLineDashType || !s[p - 1].lineDashType)) && (x[x.length - 1].newLineDashArray = n, q = m.nullDataLineDashType) : (d(x), x = [])), u = !0;
          else {
    ...
    p.prototype.renderColumn                = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c                                                                   = null, e = this.plotArea, g = 0, k, l,
            w,
        ...
        for (s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < B.length) for (var p = 5 < q && f.bevelEnabled ? !0 : !1, g = 0; g < B.length; g++) if (B[g].getTime ? w = B[g].x.getTime() :
    ...
    p.prototype.renderStackedColumn         = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c = null, e = this.plotArea, g = [], k = [], l = [], w = [], m = 0, s, q,
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          var h                   = a.dataSeriesIndexes[B],
              p = this.data[h], t = p.dataPoints;
          if (0 < t.length) {
            var u         = 5 < f && p.bevelEnabled ? !0 : !1;
            b.strokeStyle = "#4572A7 ";
            for (m = 0; m < t.length; m++) if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
              ...
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) l[c] = t[m].y + (l[c] ? l[c] : 0), 0 < l[c] && (q = a.axisY.convertValueToPixel(l[c]),
                y = "undefined" !== typeof g[c] ? g[c] : n, g[c] = q); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) w[c] = t[m].y + (w[c] ? w[c] : 0), y = a.axisY.convertValueToPixel(w[c]), q = "undefined" !== typeof k[c] ? k[c] : n, k[c] = y; else if (q = a.axisY.convertValueToPixel(t[m].y), 0 <= t[m].y) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          var p                   = a.dataSeriesIndexes[B],
              h = this.data[p], t = h.dataPoints;
          if (0 < t.length) for (var u = 5 < f && h.bevelEnabled ? !0 : !1, m = 0; m < t.length; m++) if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[m].y) {
            s     = a.axisX.convertValueToPixel(c);
            ...
            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) {
              ...
              y    = g[c] ? g[c] : n;
              g[c] = q
            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) w[c] = q + ("undefined" !== typeof w[c] ? w[c] : 0), y = a.axisY.convertValueToPixel(w[c]), q = k[c] ? k[c] : n, k[c] = y; else if (q = a.axisY.convertValueToPixel(q), 0 <= t[m].y) {
              var A = "undefined" !== typeof g[c] ? g[c] : 0;
              q -= A;
              y     = n - A;
    ...
    p.prototype.renderBar                   = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c                            =
              null, e = this.plotArea, g = 0, k, l, w,
            m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
        ...
        for (s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < B.length) {
            ...
            b.strokeStyle = "#4572A7 ";
            for (g = 0; g < B.length; g++) if (B[g].getTime ? w = B[g].x.getTime() : w = B[g].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax) && "number" === typeof B[g].y) {
        ...
        return {
          ...
          easingFunction   : M.easing.easeOutQuart,
          animationBase    : m < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : m > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
            m
        }
      }
    };
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < t.length) {
            ...
            b.strokeStyle = "#4572A7 ";
            for (m = 0; m < t.length; m++) if (c = t[m].x.getTime ? t[m].x.getTime() :
              ...
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) l[c] = t[m].y + (l[c] ? l[c] : 0), 0 < l[c] && (y = g[c] ? g[c] : n, g[c] = s = a.axisY.convertValueToPixel(l[c])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[m].y) w[c] = t[m].y + (w[c] ? w[c] : 0), s = k[c] ?
                k[c] : n, k[c] = y = a.axisY.convertValueToPixel(w[c]); else if (s = a.axisY.convertValueToPixel(t[m].y), 0 <= t[m].y) {
                var A = g[c] ? g[c] : 0;
                y     = n + A;
                s += A;
                g[c]  = A + (s - y)
    ...
    p.prototype.renderStackedBar100         = function (a) {
      var d                                           =
            a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c = null, e = this.plotArea, g = [], k = [], l = [], w = [], m = 0, s, q,
            n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            m = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < t.length) {
            var u         = 5 < f && p.bevelEnabled ? !0 : !1;
            b.strokeStyle = "#4572A7 ";
            for (m = 0; m < t.length; m++) if (c = t[m].x.getTime ? t[m].x.getTime() : t[m].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
            "number" === typeof t[m].y) {
              q     = a.axisX.convertValueToPixel(c);
              var x;
              ...
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[m].y) {
                ...
                n, k[c] = x = a.axisY.convertValueToPixel(w[c]); else if (s = a.axisY.convertValueToPixel(x), 0 <= t[m].y) {
                var A = g[c] ? g[c] : 0;
                x     = n + A;
                s += A;
        ...
        return {
          ...
          animationCallback: M.xScaleAnimation,
          easingFunction   : M.easing.easeOutQuart,
          animationBase    : n < a.axisY.bounds.x1 ? a.axisY.bounds.x1 :
    ...
    p.prototype.renderArea                  = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var k = this._eventManager.ghostCtx, l = a.axisX.lineCoordinates, w = a.axisY.lineCoordinates, m = [],
            s = this.plotArea, q;
        g.save();
        r && k.save();
        g.beginPath();
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < p.length) {
            ...
            for (var da = !0; h < p.length; h++) if (x = p[h].x.getTime ? p[h].x.getTime() :
    ...
    p.prototype.renderSplineArea            = function (a) {
      function d() {
        ...
        if (0 < b.length) {
          if (0 < q.lineThickness) {
            ...
            for (var d = 0; d < b.length - 3; d += 3) if (c.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), r && e.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), b[d + 3].newStrokeStyle || b[d + 3].newLineDashArray) c.stroke(),
      ...
      var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = this._eventManager.ghostCtx, g = a.axisX.lineCoordinates, k = a.axisY.lineCoordinates, l = [],
            w = this.plotArea;
        c.save();
        r &&
        e.save();
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < n.length) {
            var ma                                             = q._colorSet[f % q._colorSet.length],
                y = q.lineColor = q.options.lineColor || ma, A = y;
            c.fillStyle = ma;
            c.strokeStyle = y;
            ...
            for (h = !1; f < n.length; f++) if (B = n[f].x.getTime ? n[f].x.getTime() : n[f].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !h))) if ("number" !== typeof n[f].y) 0 < f && !h && (q.connectNullData ? c.setLineDash && (0 < x.length && (q.options.nullDataLineDashType ||
    ...
    p.prototype.renderStepArea              = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var f                                                               =
                a.dataSeriesIndexes[n], B = this.data[f], h = B.dataPoints, m = B.id;
          ...
          if (0 < h.length) {
            ...
            if (g.setLineDash) {
              var ca                     = R(B.nullDataLineDashType, B.lineThickness),
                  Y = B.lineDashType, da = R(Y, B.lineThickness);
              g.setLineDash(da)
            }
    ...
    p.prototype.renderStackedArea           = function (a) {
      ...
      var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, g = null, k = [], l = this.plotArea, w = [], m = [], s = [], q = [], n = 0, f, h,
            p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            u = this._eventManager.ghostCtx, t, C, x;
        r && u.beginPath();
        c.save();
        r && u.save();
        c.beginPath();
        ...
        for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
          var y                           =
                a.dataSeriesIndexes[v], A = this.data[y], z = A.dataPoints;
          A.dataPointIndexes              = [];
        ...
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < s.length) {
            ...
            for (var da = !0, n = 0; n < s.length; n++) {
              ...
              if (!(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !da))) if ("number" !== typeof Z.y) A.connectNullData || (da || C) || d(), da = !0; else {
    ...
    p.prototype.renderStackedArea100        = function (a) {
      ...
      var b = a.targetCanvasCtx || this.plotArea.ctx, c = r ? this._preRenderCtx : b;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, g = null, k = this.plotArea, l = [], w = [], m = [], s = [], q = [], n = 0, f, h, p, u, t,
    ...
    p.prototype.renderBubble                = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = -Infinity, w = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) for (var s                                            = a.dataSeriesIndexes[m],
        ...
        for (var h = 25 * Math.PI, p = Math.max(Math.pow(0.25 * Math.min(c.height, c.width) / 2, 2) * Math.PI, h), m = 0; m < a.dataSeriesIndexes.length; m++) if (s = a.dataSeriesIndexes[m], q = this.data[s], n = q.dataPoints, 0 < n.length) for (b.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++) if (g = n[e].getTime ? g = n[e].x.getTime() :
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < s.length) {
            ...
            for (var q = 0, n = 0, e = 0; e < s.length; e++) if (g = s[e].getTime ? g = s[e].x.getTime() : g = s[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[e].y) {
              g             = a.axisX.convertValueToPixel(g);
    ...
    p.prototype.renderCandlestick           = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < C.length) for (var x = 5 < h && t.bevelEnabled ? !0 : !1, l = 0; l < C.length; l++) if (C[l].getTime ? f = C[l].x.getTime() : f = C[l].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(C[l].y) && C[l].y.length &&
    ...
    p.prototype.renderBoxAndWhisker         = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e                            =
              null, g = this.plotArea, k = 0, l, w, m, s, q, n, f,
            e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
        ...
        for (var p = !1, p = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          if (0 < x.length) for (var z = 5 < h && C.bevelEnabled ? !0 : !1, k = 0; k < x.length; k++) if (x[k].getTime ? f = x[k].x.getTime() : f = x[k].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !u(x[k].y) && x[k].y.length && "number" === typeof x[k].y[0] && "number" === typeof x[k].y[1] && "number" === typeof x[k].y[2] && "number" === typeof x[k].y[3] && "number" === typeof x[k].y[4] && 5 === x[k].y.length) {
            ...
            var y = l - h / 2 << 0, A = l + h / 2 << 0,
                e = x[k].color ? x[k].color : C._colorSet[0],
                D = Math.round(Math.max(1, 0.15 * h)), aa = 0 === D % 2 ? 0 : 0.5,
                ...
                K                                         = 1 === Math.round(H) % 2 ? 0.5 : 0, L  = C.upperBoxColor,
                O                                         = C.lowerBoxColor, Q                    = u(C.options.fillOpacity) ? 1 : C.fillOpacity,
                P                                         = C.dataPointIds[k];
    ...
    p.prototype.renderRangeColumn           = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c = null, e = this.plotArea, g = 0, k, l, w,
            g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
              1;
        ...
        for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < f.length) for (var h                                      =
            ...
            var p            = a.axisX.reversed ? c + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + s) * m << 0 : c - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount +
              s) * m << 0, v = a.axisX.reversed ? p - m << 0 : p + m << 0,
            ...
            if (f[g].indexLabel || n.indexLabel || f[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
              ...
              dataSeries  : n,
              indexKeyword: 1,
              point       : {x: p + (v - p) / 2, y: f[g].y[1] >= f[g].y[0] ? k : l},
              direction   : f[g].y[1] >= f[g].y[0] ? 1 : -1,
              bounds      : {x1: p, y1: Math.min(k, l), x2: v, y2: Math.max(k, l)},
              color       : c
            })
      ...
      function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
            var x = a.dataSeriesIndexes[C], z = this.data[x], y = z.dataPoints,
                A = u(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/ig) && z._linkedSeries.visible ? !0 : !1,
                D = 0;
            if (A) for (e = z._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
            ...
            (t = e);
            t > l && (t = l);
            if (0 < y.length) for (var aa = z._colorSet, l = 0; l < y.length; l++) {
    ...
    p.prototype.renderRangeBar              = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, b = r ? this._preRenderCtx :
        d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c = null, e = this.plotArea, g = 0, k, l, w, m,
            g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < h.length) {
            ...
            b.strokeStyle = "#4572A7 ";
            for (g = 0; g < h.length; g++) if (h[g].getTime ? m = h[g].x.getTime() : m = h[g].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !u(h[g].y) && h[g].y.length && "number" === typeof h[g].y[0] && "number" === typeof h[g].y[1]) {
    ...
    p.prototype.renderRangeArea             = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          var w                           =
                [], m                     = a.dataSeriesIndexes[l], s = this.data[m], q = s.dataPoints, g = s.id;
          ...
          if (0 < q.length) {
            ...
            q.length; f++) if (t = q[f].x.getTime ? q[f].x.getTime() : q[f].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!s.connectNullData || !T))) if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
              ...
              1].newLineDashArray = D, A = s.nullDataLineDashType, c.setLineDash(z)), c.lineTo(h, p), r && e.lineTo(h, p), w.push({
                x: h,
                y: u
              })) : (c.beginPath(), c.moveTo(h, p), C = {x: h, y: p}, w = [], w.push({
                x: h,
                y: u
    ...
    p.prototype.renderWaterfall             = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var c = this._eventManager.ghostCtx, e = null, g = this.plotArea, k = 0, l, h, m, s,
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < v.length) for (var x = 5 < n && u.bevelEnabled ? !0 : !1, z = !1, y = null, A = null, k = 0; k < v.length; k++) if (v[k].getTime ? s = v[k].x.getTime() : s = v[k].x, "number" !== typeof v[k].y) {
    ...
    p.prototype.renderPie                   = function (a) {
      function d() {
        if (m && s) {
          for (var a = 0, b = 0, c = 0, e = 0, d = 0; d < s.length; d++) {
            ...
            var k                = f[d], q = {percent: null, total: null}, p = null, q = h.getPercentAndTotal(m,
              g);
      ...
      function e(a) {
        for (var b = null, e = 1; e < s.length; e++) if (b = (a + e + f.length) % f.length, f[b].hemisphere !== f[a].hemisphere) {
          b = null;
          break
        } else if (f[b].indexLabelText && b !== a && (0 > c(f[b], f[a]) || ("right" === f[a].hemisphere ? f[b].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y : f[b].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y))) break; else b = null;
        return b
      }
      ...
      function g(a, b, d) {
        ...
        if (0 <= a && a < s.length) {
          ...
          m = null;
          for (l = 1; l < s.length; l++) if (m = (a - l + f.length) % f.length, f[m].hemisphere !== f[a].hemisphere) {
            m = null;
            break
          } else if (f[m].indexLabelText &&
            f[m].hemisphere === f[a].hemisphere && m !== a && (0 > c(f[m], f[a]) || ("right" === f[a].hemisphere ? f[m].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y : f[m].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))) break; else m = null;
          q = m;
          h = e(a);
          l = m = 0;
      ...
      function k() {
        ...
        for (var b = a = 0, d = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
          ...
          } else for (a = 0; a < s.length; a++) l = f[a], r = "pie" === m.type ? 0.7 * A : 0.8 * A, y = x.x + r * Math.cos(l.midAngle), u = x.y + r * Math.sin(l.midAngle), l.indexLabelTextBlock.x = y, l.indexLabelTextBlock.y = u;
          for (a = 0; a < s.length; a++) if (l = f[a], y = l.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === l.hemisphere ? (y = n.x2 - (l.indexLabelTextBlock.x + l.indexLabelTextBlock.width +
          ...
          var K = function (a,
            ...
            for (b = 0; b < e.length; b++) if (c = e[b], d < 0.7 * a) d += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText(); else break
          };
          (function () {
              ...
              if (null !== k) {
                ...
                if (n = 0 > z) {
                  ...
                  var h  = t.indexLabelTextBlock.y - t.indexLabelTextBlock.height /
                    2, w = t.indexLabelTextBlock.y + t.indexLabelTextBlock.height / 2,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var m                                                                                                       =
              this.data[a.dataSeriesIndexes[0]], s = m.dataPoints, q = 10, n = this.plotArea, f = m.dataPointEOs, p = 2,
            r, v = 1.3, t = 20 / 180 * Math.PI, C = 6,
            x = {x: (n.x2 + n.x1) / 2, y: (n.y2 + n.y1) / 2}, z = 0;
        a = !1;
    ...
    p.prototype.renderFunnel                = function (a) {
      ...
      function e() {
        ...
        if (d) for (k = J.length - 1; 0 <= k; k--) a = P[k], J[k].textBlock.maxWidth =
      ...
      function k() {
        ...
        function c(a, b, d) {
          ...
          for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += J[b.id].height + ga, J[b.id].textBlock.text = "", J[b.id].indexLabelText = "", J[b.id].isDirty = !0, J[b.id].textBlock.measureText(); else break;
          return g
        }
      ...
      function f(a) {
        for (var b, c = 0; c < C.length; c++) if (P[c].y1 < a && P[c].y4 > a) {
          b = P[c];
          break
        }
      ...
      function v(a) {
        ...
        if (z.subtitles) for (var b = 0; b < z.subtitles.length; b++) {
          var c = z.subtitles[b];
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        var I = x.x1 + y, L = x.x2 - y, O = x.y1 + D, Z = x.y2 - D,
        ...
        if (0 != t.length && (t.dataPoints &&
          ...
          var y = I + a / 2, $ = I, V = I + a, pa = t.reversed ? Z : O, K = y - G / 2, ea = y + G / 2,
              Da = t.reversed ? O + N : Z -
                N, wa                                                                     = t.reversed ? O : Z;
          a                                                                               = [];
          var y                                                                           = [], P                                                                   = [], E = [], X = O, fa, ba = (Da - pa) / (K - $), ha = -ba,
              I                                                                           = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? b() : d();
          if (-1 !== I) {
            if (t.reversed) for (E.push(X), G = I.length - 1; 0 < G; G--) X += I[G], E.push(X); else for (G = 0; G < I.length; G++) X += I[G], E.push(X);
            if (t.reversed) for (G = 0; G < I.length; G++) E[G] < Da ? (a.push(K), y.push(ea), fa = G) : (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha)); else for (G = 0; G < I.length; G++) E[G] < Da ? (a.push((E[G] - pa + ba * $) / ba), y.push((E[G] - pa + ha * V) / ha), fa = G) : (a.push(K), y.push(ea));
            ...
            if (!H) for (G = 0; G < C.length; G++) A = t.dataPointIds[G], a = {
              id             : A,
              objectType     : "dataPoint",
              dataPointIndex : G,
              dataSeriesIndex: 0,
    ...
    p.prototype.getPercentAndTotal          = function (a, d) {
      var b = null, c = null,
          e           = null;
      if (0 <= a.type.indexOf("stacked")) c = 0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], e = isNaN(d.y) ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" === a.type || "funnel" === a.type || "pyramid" === a.type) {
    ...
    p.prototype.replaceKeywordsWithValue    = function (a, d, b, c, e) {
      ...
      if ((0 <= b.type.indexOf("stacked") ||
        ...
        var k = "#percent", l = "#total", h = this.getPercentAndTotal(b, d), l = isNaN(h.total) ? l : h.total,
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if (d.hasOwnProperty(a)) f = d; else if (b.hasOwnProperty(a)) f = b; else return "";
        f = f[a];
        null !== k && (f = f[k]);
        if ("x" === a) if ("dateTime" === b.axisX.valueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {
    ...
    H.prototype.render    = function () {
      var a = this.bounds.x1, d = this.bounds.y1, b = this.markerMargin, c = this.maxWidth, e = this.maxHeight,
          g = this.markerSize, k = this.rows;
        ...
        for (var m = k[h], s = 0, q = 0; q < m.items.length; q++) {
          ...
          if ("error" === n.chartType) {
            ...
            var r                                                            = f - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                t = p + 0.15 * this.lineHeight, v = 0.7 * this.lineHeight, x = v + 0.02 * this.lineHeight;
            this.ctx.moveTo(r, t);
    ...
    F.prototype.getDataPointAtX         = function (a, d) {
      ...
      var b = {dataPoint: null, distance: Infinity, index: NaN}, c = null, e = 0, g = 0, k = 1, l = Infinity, h = 0,
          m = 0, s = 0;
    ...
    F.prototype.getDataPointAtXY        = function (a, d, b) {
      ...
      b = b || !1;
      var c = [], e = 0, g = 0, k = 1, l = !1, h = Infinity,
          m                                      = 0, s = 0, q = 0;
      if ("none" !== this.chart.plotInfo.axisPlacement) if (q = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
        ...
        y: d
                                      ...
                                      q = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(q / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, q = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (q - this.dataPoints[0].x) >>
        ...
        if (0 <= g && g < this.dataPoints.length) {
          ...
          if (n) {
            switch (this.type) {
              ...
              case "splineArea":
              case "scatter":
                var u = na("markerSize", f, this) || 4, r = b ? 20 : u,
    ...
    z.prototype.createLabels                              = function () {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        if (this.labels) {
          a = Math.ceil(c);
          for (var c = Math.ceil(this.intervalStartPosition), f = !1, b = c; b < this.viewportMaximum; b += a) if (this.labels[b]) f = !0; else {
            f = !1;
            break
          }
          f && (this.interval = a, this.intervalStartPosition = c)
        }
        if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), c = 0, f = n; c < this.logLabelValues.length; c++) if (b = this.logLabelValues[c], b < this.viewportMinimum) c++; else {
      ...
      e = [];
      n = q = 0;
      if (this.labelAutoFit || this.options.labelAutoFit) if (u(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (g = 0.9 * l >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
        ...
        this.viewportMinimum ? 1 : 0; b < this._labels.length; b++) if (!this._labels[b].breaksLabelType) {
          a = this._labels[b].textBlock;
          B = a.measureText();
          for (f = b + 1; f < this._labels.length; f++) if (!this._labels[f].breaksLabelType) {
          ...
          c = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (k - a.fontSize / 2) *
            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
          if (u(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), p = (m - (h + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !u(this.options.labelWrap)) this.labelWrap ? u(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth =
      ...
      for (b = 0; b < this.stripLines.length; b++) {
        ...
        a = new ka(this.ctx, {
          ...
          fontWeight     : "outside" === g.labelPlacement ? g.options.labelFontWeight ? g.labelFontWeight : this.labelFontWeight :
            g.labelFontWeight,
    ...
    z.prototype.createLabelsAndCalculateWidth             = function () {
      ...
      if ("left" === this._position || "right" === this._position) {
        ...
        for (d =
          ...
          var c = this._labels[d].textBlock, e = c.measureText(), g = 0,
    ...
    z.prototype.createLabelsAndCalculateHeight            = function () {
      ...
      this._stripLineLabels = [];
      var d,
          b                 = 0, c = this.chart.isNavigator ? 0 : 5;
      this.createLabels();
      if ("bottom" === this._position || "top" === this._position) {
        for (b = 0; b < this._labels.length; b++) {
          d = this._labels[b].textBlock;
          var e = d.measureText(), g = 0,
    ...
    z.setLayout                                           = function (a, d, b, c, e, g) {
      ...
      for (f = 0; f < n.length; f++) if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length) for (var r                                    =
      ...
      if ("normal" === e) {
        for (var C = [], x = [], D = [], y = [], M = [], N = [], O = [], Q = []; 4 > v;) {
          ...
          if (b &&
            0 < b.length) for (D = [], f = P = 0; f < b.length; f++) D.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateWidth() : 0)), P += D[f], K += b[f] && !p.isNavigator ? b[f].margin : 0; else D.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          O.push(D);
          if (c && 0 < c.length) for (y = [], f = ba = 0; f < c.length; f++) y.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateWidth() : 0)), ba += y[f], $ += c[f] ? c[f].margin : 0; else y.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          Q.push(y);
          k = Math.round(g.x1 + P + K);
          h = Math.round(g.x2 - ba - $ > p.width -
          q ? p.width - q : g.x2 - ba - $);
          if (a && 0 < a.length) for (C = [], f = V = 0; f < a.length; f++) a[f] && (a[f].lineCoordinates = {}), a[f].lineCoordinates.width = Math.abs(h - k), a[f].title && (a[f]._titleTextBlock.maxWidth = 0 < a[f].titleMaxWidth && a[f].titleMaxWidth < a[f].lineCoordinates.width ? a[f].titleMaxWidth : a[f].lineCoordinates.width), C.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateHeight() : 0)), V += C[f], e += a[f] && !p.isNavigator ? a[f].margin : 0; else C.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
          M.push(C);
          if (d && 0 < d.length) for (x =
          ...
          N.push(x);
          if (a && 0 < a.length) for (f = 0; f < a.length; f++) a[f] && (a[f].lineCoordinates.x1 =
          ...
          if (b && 0 < b.length) for (f = 0; f < b.length; f++) K = p.isNavigator ? 0 :
          ...
          if (c && 0 < c.length) for (f = 0; f < c.length; f++) c[f] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), h = Math.round(k), K = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(g.y1 + X + W < Math.max(K, q) ? Math.max(K, q) : g.y1 +
          ...
          if (0 < v) {
            if (a && 0 < a.length) for (f = 0; f < a.length; f++) r = M[v - 1][f] === M[v][f] ? !0 : !1; else r = !0;
            if (d && 0 < d.length) for (f = 0; f < d.length; f++) H = N[v - 1][f] === N[v][f] ? !0 : !1; else H = !0;
            if (b && 0 < b.length) for (f = 0; f < b.length; f++) I = O[v - 1][f] === O[v][f] ? !0 : !1; else I = !0;
            if (c && 0 < c.length) for (f = 0; f < c.length; f++) L = Q[v - 1][f] === Q[v][f] ? !0 : !1; else L = !0
          }
          if (r && H && I && L) break;
          v++
        }
        if (a && 0 < a.length) for (f = 0; f < a.length; f++) a[f].calculateStripLinesThicknessInValues(), a[f].calculateBreaksInPixels();
        if (d && 0 < d.length) for (f = 0; f < d.length; f++) d[f].calculateStripLinesThicknessInValues(),
        ...
        for (N = []; 4 > v;) {
          ...
          if (a && 0 < a.length) for (F = [], f = U = 0; f < a.length; f++) F.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateWidth() : 0)), U += F[f], e += a[f] && !p.isNavigator ? a[f].margin : 0; else F.push(Math.ceil(a[0] ?
            a[0].createLabelsAndCalculateWidth() : 0));
          M.push(F);
          if (d && 0 < d.length) for (z = [], f = V = 0; f < d.length; f++) z.push(Math.ceil(d[f] ? d[f].createLabelsAndCalculateWidth() : 0)), V += z[f], W += d[f] ? d[f].margin : 0; else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
          N.push(z);
          if (b && 0 < b.length) for (f = 0; f < b.length; f++) b[f].lineCoordinates = {}, k = Math.round(g.x1 + U + e), h = Math.round(g.x2 - V - W > p.width - 10 ? p.width - 10 : g.x2 - V - W), b[f].labelAutoFit && !u(C) && (0 < !a.length && (k = 0 > b[f].labelAngle ? Math.max(k, C) : 0 === b[f].labelAngle ?
          ...
          if (c && 0 < c.length) for (f = 0; f < c.length; f++) c[f].lineCoordinates = {}, k = Math.round(g.x1 + U + e), h = Math.round(g.x2 - V - W > c[f].chart.width - 10 ? c[f].chart.width - 10 : g.x2 - V - W), c[f] &&
          ...
          if (b && 0 < b.length) for (q = [], f = S = 0; f < b.length; f++) q.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateHeight() : 0)), S +=
            q[f] + b[f].margin, K += b[f].margin; else q.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          E.push(q);
          if (c && 0 < c.length) for (A = [], f = R = 0; f < c.length; f++) A.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)), R += A[f], $ += c[f].margin; else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          t.push(A);
          if (b && 0 < b.length) for (f = 0; f < b.length; f++) 0 < b[f]._labels.length && (m = b[f]._labels[0], l = b[f]._labels[b[f]._labels.length - 1], C = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
          ...
          if (c && 0 < c.length) for (f = 0; f < c.length; f++) c[f] && 0 < c[f]._labels.length && (m = c[f]._labels[0], l = c[f]._labels[c[f]._labels.length - 1], D = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI /
          ...
          if (p.panEnabled) for (f = 0; f < b.length; f++) q[f] = p.sessionVariables.axisY.height; else for (f = 0; f < b.length; f++) p.sessionVariables.axisY.height = q[f];
          if (b && 0 < b.length) for (f = b.length - 1; 0 <= f; f--) l = Math.round(g.y2), m = Math.round(g.y2 > b[f].chart.height - 10 ? b[f].chart.height - 10 : g.y2), b[f].lineCoordinates.y1 = l - (q[f] + b[f].margin +
          ...
          if (c && 0 < c.length) for (f = c.length - 1; 0 <= f; f--) c[f] && (l = Math.round(g.y1), m = Math.round(g.y1 + (A[f] + c[f].margin + G)), c[f].lineCoordinates.y1 = m, c[f].lineCoordinates.y2 = m, c[f].bounds = {
            x1                                                     : k, y1: l +
          ...
          if (a && 0 < a.length) for (f = 0; f < a.length; f++) {
            ...
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h, k = 0 > b[K].labelAngle || 0 === b[K].labelAngle ? h - U : k);
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (h = c[K].lineCoordinates.x1, k = h - U);
            a[f].lineCoordinates =
          ...
          if (d && 0 < d.length) for (f = 0; f < d.length; f++) {
            ...
            m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - S > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : g.y2 - S) : g.y2 > p.height - Math.max(K, 10) ? p.height - Math.max(K, 10) : g.y2;
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (h = 0 > b[K].labelAngle ? Math.max(h, C) : 0 === b[K].labelAngle ? Math.max(h, C / 2) : h, k = 0 > b[K].labelAngle || 0 ===
            b[K].labelAngle ? h - V : k);
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (h = c[K].lineCoordinates.x2, k = h - V);
          ...
          if (0 < v) {
            if (a && 0 < a.length) for (f = 0; f < a.length; f++) r = M[v - 1][f] === M[v][f] ? !0 : !1; else r = !0;
            if (d && 0 < d.length) for (f = 0; f < d.length; f++) H = N[v - 1][f] === N[v][f] ? !0 : !1; else H = !0;
            if (b && 0 < b.length) for (f = 0; f < b.length; f++) I = E[v - 1][f] === E[v][f] ? !0 : !1; else I = !0;
            if (c && 0 < c.length) for (f = 0; f < c.length; f++) L = t[v - 1][f] === t[v][f] ? !0 : !1; else L = !0
          }
          if (r && H && I && L) break;
          v++
        }
    ...
    z.render                                              = function (a, d, b, c, e) {
      ...
      e.clip();
      if (a && 0 < a.length) for (l = 0; l < k.length; l++) k[l].renderStripLinesOfThicknessType("value");
      ...
      e.restore();
      if (a && 0 < a.length) for (l = 0; l < a.length; l++) a[l].renderGrid(), r && (a[l].createMask(), a[l].renderBreaksBackground());
    ...
    z.prototype.renderLabelsTicksAndTitle                 = function () {
      ...
      if ("undefined" ===
        ...
        if ("left" === this._position || "right" === this._position) if (this.logarithmic &&
      ...
      if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationIterationEnd",
        ...
        }, this); else for (m = 0; m < this._labels.length; m++) q = this._labels[m], q.position < this.viewportMinimum || (q.position > this.viewportMaximum || d && 0 !== g++ % 2 && this.labelAutoFit) || q.textBlock.render(!0)
    };
    ...
    z.prototype.renderStripLinesOfThicknessType           = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        ...
        for (c = 0; c < this._stripLineLabels.length; c++) if (m = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
          ...
          if ("outside" === b.stripLine.labelPlacement) if (m && (this.ctx.strokeStyle =
        ...
        if (k) for (k = !1, c = 0; c < h.length; c++) b = h[c], b.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
    ...
    z.prototype.renderGrid                                = function () {
      if (this.gridThickness && 0 < this.gridThickness) {
        ...
        if ("bottom" === this._position || "top" === this._position) for (c = 0; c < this._labels.length; c++) this._labels[c].position <
    ...
    z.prototype.renderAxisLine                            = function () {
      var a = this.chart.ctx, d = r ? this.chart._preRenderCtx : a,
          b = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)),
          c = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, g;
      d.save();
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.beginPath();
          if (this.scaleBreaks && !u(this.scaleBreaks.firstBreakIndex)) if (u(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c; else for (var l =
    ...
    z.prototype.convertPixelToValue                       = function (a) {
      ...
      var d = 0, b = 0, c, d = !0, e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [],
      ...
      if (this.logarithmic) {
        ...
        if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (b = 0; b < e.length; b++) {
          if (!(e[b].endValue < this.conversionParameters.minimum)) if (d) if (e[b].startValue < this.conversionParameters.minimum) {
            ...
            c /= e[b].size;
            d = !1
          } else break; else if (c > e[b].startValue / e[b - 1].endValue) {
          ...
          c *= e[b].size;
          d = !1
        } else break; else if (c < e[b].endValue / e[b + 1].startValue) {
        ...
        if (b <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed) for (b = 0; b < e.length; b++) {
          ...
          break
        } else a += e[b].startValue - this.conversionParameters.minimum + e[b].size * (this.conversionParameters.minimum - e[b].startValue) / (e[b].endValue - e[b].startValue), c += e[b].size * (this.conversionParameters.minimum - e[b].startValue) / (e[b].endValue - e[b].startValue), d = !1; else if (c < e[b].endValue - this.conversionParameters.minimum) {
    ...
    z.prototype.calculateValueToPixelConversionParameters = function (a) {
      ...
      var d = {pixelPerUnit: null, minimum: null, reference: null}, b = this.lineCoordinates.width,
          c = this.lineCoordinates.height, b = "bottom" === this._position || "top" === this._position ? b : c,
          c = Math.abs(this.range);
      if (this.logarithmic) for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <=
      a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * a[e].startValue, b = 0 < a[e].spacing.toString()
        .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100) : b - Math.min(a[e].spacing, 0.1 * b)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c / a[e].endValue * this.viewportMinimum, b = 0 < a[e].spacing.toString()
        .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) :
        b - Math.min(a[e].spacing, 0.1 * b) * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (c = c / this.viewportMaximum * a[e].startValue, b = 0 < a[e].spacing.toString()
        .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
      else for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? b = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c - a[e].endValue + a[e].startValue, b = 0 < a[e].spacing.toString()
        .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100) : b - Math.min(a[e].spacing, 0.1 * b)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (c = c - a[e].endValue + this.viewportMinimum,
        b = 0 < a[e].spacing.toString()
          .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : b - Math.min(a[e].spacing, 0.1 * b) * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (c = c - this.viewportMaximum + a[e].startValue, b = 0 < a[e].spacing.toString()
        .indexOf("%") ? b * (1 - parseFloat(a[e].spacing) / 100 * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)) :
    ...
    z.prototype.calculateAxisParameters                   = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
        ...
        if (u(this.options.viewportMinimum) && !u(this.sessionVariables.newViewportMinimum) && !isNaN(this.sessionVariables.newViewportMinimum)) this.viewportMinimum = this.sessionVariables.newViewportMinimum; else if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = this.minimum;
        ...
        if (this.scaleBreaks) for (c = 0; c < this.scaleBreaks._appliedBreaks.length; c++) if ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue || !u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[c].startValue || !u(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[c].startValue) &&
    ...
    z.prototype.calculateLogarithmicAxisParameters        = function () {
      ...
      if (this.scaleBreaks) for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++) if ((!u(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue || !u(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[k].startValue ||
    ...
    z.getNiceExponent                                     = function (a, d) {
      var b = Math.floor(Math.log(a) / Math.LN10), c = a / Math.pow(10, b),
    ...
    z.prototype.getLabelStartPoint                        = function () {
      ...
      if ("millisecond" !== this.intervalType) if ("second" === this.intervalType) 0 < a.getMilliseconds() && (a.setSeconds(a.getSeconds() + 1), a.setMilliseconds(0)); else if ("minute" ===
        this.intervalType) {
    ...
    L.prototype.render            = function (a) {
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (c = 1 === q % 2 ? (c.x << 0) + 0.5 : c.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 :
          ...
          x2: k + q / 2,
          y2: l
        }, this.ctx.moveTo(c, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(c, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e); else if ("wavy" === this.type) {
          h = c;
          m = e;
          g = 0.5;
          p = (l - m) / a / 3;
          ...
          this.scaleBreaks.parent._position) if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === q % 2 ? (c.y << 0) + 0.5 : c.y << 0, "left" === this.scaleBreaks.parent._position ? (c = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (c = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
          x1: c,
          y1: e - q / 2,
          x2: k,
          y2: l + q / 2
          ...
          this.ctx.lineTo(c, l); else if ("wavy" === this.type) {
          h = c;
          m = e;
          g = 0.5;
          p = (k - h) / a / 3;
    ...
    fa.prototype.render = function (a, d) {
      ...
      var l = null === this.opacity ? 1 : this.opacity,
          ...
          p = this.chart.overlaidCanvasCtx, q = p.globalAlpha;
      p.globalAlpha = l;
      p.beginPath();
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          var f = null;
          if ("bottom" === this.parent._position || "top" === this.parent._position) n = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) n = this.parent.convertPixelToValue({y: d});
          for (var r = 0; r <
          ...
          r = 0;
          if ("rangeBar" === k[0].dataSeries.type || "error" === k[0].dataSeries.type) for (var f = Math.abs(a - this.parent.convertValueToPixel(k[r].dataPoint.y[0])), v = 0, n = 0; n < k.length; n++) if (k[n].dataPoint.y &&
          ...
          if ("bottom" === this.parent._position ||
            ...
            t           = !1;
            if (this.parent.labels) for (k = Math.ceil(this.parent.interval), n = 0; n < this.parent.viewportMaximum; n += k) if (this.parent.labels[n]) t = !0; else {
              t = !1;
              break
            }
            if (t) {
              if ("axisX" === this.parent.type) for (n =
                                                       this.parent.convertPixelToValue({y: d}), f = null, r = 0; r < this.parent.dataSeries.length; r++) (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (l.text = this.labelFormatter ? this.labelFormatter({
                chart    : this.chart,
                axis     : this.parent.options,
                crosshair: this.options,
                value    : h.dataPoint.x
          ...
          if (t) {
            if ("axisX" ===
              this.parent.type) for (n = this.parent.convertPixelToValue({x: a}), f = null, r = 0; r < this.parent.dataSeries.length; r++) (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (l.text = this.labelFormatter ? this.labelFormatter({
              chart    : this.chart,
              axis     : this.parent.options,
              crosshair: this.options,
              value    : h.dataPoint.x
          ...
          r = 0;
          if ("rangeColumn" === k[0].dataSeries.type || "rangeArea" === k[0].dataSeries.type || "error" === k[0].dataSeries.type || "rangeSplineArea" === k[0].dataSeries.type || "candlestick" === k[0].dataSeries.type || "ohlc" === k[0].dataSeries.type || "boxAndWhisker" === k[0].dataSeries.type) for (f = Math.abs(d - this.parent.convertValueToPixel(k[0].dataPoint.y[0])), n = v = 0; n < k.length; n++) if (k[n].dataPoint.y &&
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
          ...
          if (t) {
            if ("axisX" === this.parent.type) for (n = this.parent.convertPixelToValue({x: a}), f = null, r = 0; r < this.parent.dataSeries.length; r++) (f = this.parent.dataSeries[r].getDataPointAtX(n, !0)) && 0 <= f.index && (l.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options,
                crosshair: this.options,
                value: this.parent.convertPixelToValue(a)
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          if ("xySwapped" ===
            ...
            var l = [];
            if (this.chart.axisX) for (var h = 0; h < this.chart.axisX.length; h++) {
            ...
            if (this.chart.axisX2) for (h = 0; h < this.chart.axisX2.length; h++) {
            ...
            l = [];
            if (this.chart.axisX) for (h = 0; h < this.chart.axisX.length; h++) for (k = this.chart.axisX[h].convertPixelToValue({x: a}), m = null, c = 0; c < this.chart.axisX[h].dataSeries.length; c++) (m = this.chart.axisX[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX[h].dataSeries[c],
            null !== m.dataPoint.y && l.push(m));
            if (this.chart.axisX2) for (h = 0; h < this.chart.axisX2.length; h++) for (k = this.chart.axisX2[h].convertPixelToValue({x: a}), m = null, c = 0; c < this.chart.axisX2[h].dataSeries.length; c++) (m = this.chart.axisX2[h].dataSeries[c].getDataPointAtX(k, b)) && 0 <= m.index && (m.dataSeries = this.chart.axisX2[h].dataSeries[c], null !== m.dataPoint.y && l.push(m))
          }
          ...
          if (m = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex = m.dataPointIndex, this.currentSeriesIndex = m.dataSeries.index; else if (r) if (m = ab(a, d, this.chart._eventManager.ghostCtx), 0 < m && "undefined" !== typeof this.chart._eventManager.objectMap[m]) {
          ...
          } else this.currentDataPointIndex = -1; else this.currentDataPointIndex =
            -1;
    ...
    $.prototype.getToolTipInnerHTML     = function (a) {
      ...
      for (var d                                  = null, b                        = null,
               c = null, e = 0, g = "", k = !0, h = 0; h < a.length; h++) if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) {
        k = !1;
        break
      }
    ...
    $.prototype.fixMozTransitionDelay   = function (a, d) {
      if (20 < this.chart._eventManager.lastObjectId) this.mozContainerTransition =
        this.getContainerTransition(0); else {
        var b = parseFloat(this.container.style.left), b = isNaN(b) ? 0 : b,
            c = parseFloat(this.container.style.bottom), c = isNaN(c) ? 0 : c;
      ...
      if ("mousemove" === a.type || "click" === a.type) {
        ...
        if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c]) if (c = this.objectMap[c], "dataPoint" === c.objectType) {
          var e                                     = this.chart.data[c.dataSeriesIndex],
              g = e.dataPoints[c.dataPointIndex], h = c.dataPointIndex;
          c.eventParameter = {
            x              : b.x,
            y              : b.y,
            dataPoint      : g,
        ...
        for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
          g = !0;
          for (c = 0; c < d.length; c++) if (d[c].id === this.mouseoveredObjectMaps[b].id) {
            g = !1;
            break
          }
        ...
        for (b = 0; b < d.length; b++) {
          e = !1;
          for (c = 0; c < this.mouseoveredObjectMaps.length; c++) if (d[b].id === this.mouseoveredObjectMaps[c].id) {
            e = !0;
            break
          }
    ...
    ga.prototype.animate                = function (a, d, b, c, e) {
      ...
      for (a = []; 0 < this.animations.length;) if (d = this.animations.shift(),
...
const CanvasJSModule = canvasExportJS;
...
(() => {
/*!******************************************!*\
  !*** ./js/module/statistic/statistic.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "statistic": () => (/* binding */ statistic)
/* harmony export */ });
/* harmony import */ var _canvasjs_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvasjs.min.js */ "./js/module/statistic/canvasjs.min.js");
...
const initCharts = (dataPoints) => {
  let chart = new _canvasjs_min_js__WEBPACK_IMPORTED_MODULE_0__.CanvasJSModule.Chart("statistic", {
...
var __webpack_exports__statistic = __webpack_exports__.statistic;
export { __webpack_exports__statistic as statistic };
